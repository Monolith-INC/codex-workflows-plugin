...
> **v0.5.11** — Codex-compatible `PreToolUse` decisions, Codex MCP provisioning, session continuity, protected-branch git guard, and **project-only install** (`--dest` required; no global/`$HOME` install).
